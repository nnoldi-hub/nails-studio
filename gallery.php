...
<div class="container py-5">
    ...
    <?php foreach ($gallery_items as $item): ?>
        <div class="col-lg-4 col-md-6 mb-4">
            ...
            <?php $imgSrc = gh_get_thumb_or_original($item['image'], 'assets/images/gallery', 'assets/images/placeholder.png'); ?>
            <img src="<?php echo htmlspecialchars($imgSrc); ?>" 
                ...
                data-image="<?php echo htmlspecialchars(gh_get_display_image($item['image'], 'assets/images/gallery', 'assets/images/placeholder.png')); ?>" 
